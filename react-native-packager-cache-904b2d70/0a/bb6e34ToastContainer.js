    ...
    _this.state = {
      ...
      return _react2.default.createElement(_reactNative.Modal, {
        ...
        onRequestClose: function onRequestClose() {
          ...
          flex: 1,
          justifyContent: this.state.position === 'top' ? 'flex-start' : this.state.position === 'bottom' ? 'flex-end' : this.state.position === 'center' ? 'center' : 'flex-start' } }, _react2.default.createElement(_Toast.Toast, {
        danger: this.state.type == 'danger' ? true : false,
        success: this.state.type == 'success' ? true : false,
        warning: this.state.type == 'warning' ? true : false }, _react2.default.createElement(_Text.Text, null, this.state.text), this.state.buttonText && _react2.default.createElement(_Button.Button, { onPress: function onPress() {
          _this3.setState({
            modalVisible: false });
