  ...
  function ActionSheetContainer(props) {
    ...
    _this.state = {
      ...
      return _react2.default.createElement(_reactNative.Modal, {
        ...
        } }, _react2.default.createElement(_reactNative.TouchableOpacity, { activeOpacity: 1, onPress: function onPress() {
          return _this2.setState({ modalVisible: false });
        }, style: { backgroundColor: 'rgba(0,0,0,0.4)', flex: 1, justifyContent: 'flex-end' } }, _react2.default.createElement(_reactNative.TouchableOpacity, { activeOpacity: 1, style: { backgroundColor: '#fff', height: this.state.length * 80, padding: 15, elevation: 4 } }, _react2.default.createElement(_Text.Text, { style: { color: '#757575' } }, this.state.title), _react2.default.createElement(_List.List, { style: { marginHorizontal: -15, marginTop: 15 }, dataArray: this.state.items, renderRow: function renderRow(data, i, id) {
          return typeof _this2.state.items[0] === 'string' ? _react2.default.createElement(_ListItem.ListItem, { onPress: function onPress() {
              _this2.state.callback(id);_this2.setState({ modalVisible: false });
            }, style: { borderColor: 'transparent' } }, _react2.default.createElement(_Text.Text, null, data)) : _react2.default.createElement(_ListItem.ListItem, { onPress: function onPress() {
              _this2.state.callback(id);_this2.setState({ modalVisible: false });
            }, style: { borderColor: 'transparent' }, icon: true }, _react2.default.createElement(_Left.Left, null, _react2.default.createElement(_Icon.Icon, { name: data.icon })), _react2.default.createElement(_Body.Body, { style: { borderColor: 'transparent' } }, _react2.default.createElement(_Text.Text, null, data.text)), _react2.default.createElement(_Right.Right, null));
        } }))));
...
ActionSheetContainer.propTypes = _extends({}, _reactNative.View.propTypes, {
